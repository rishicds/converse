    ...
    <section className="w-full bg-white py-16 md:py-24">
      <div className="mx-auto max-w-6xl px-6">
        ...
        <div className="mb-10 md:mb-14">
          <h2 className="text-3xl md:text-5xl font-semibold tracking-tight flex flex-wrap items-center gap-2">
            ...
            <span className="flex items-center gap-2">
              ...
              <Image
                ...
                width={100}
                height={100}
                className="h-60 w-60 md:h-20 md:w-60 object-contain"
                priority
              />
              
            </span>
          </h2>
          <p className="mt-6 max-w-4xl text-base md:text-lg leading-relaxed text-neutral-700">
