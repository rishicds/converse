		...
		return (
			<section className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-8 sm:py-12 md:py-16 lg:py-20">
				<div className="text-center">
					<h2 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl xl:text-4xl font-semibold tracking-tight mb-6 sm:mb-8 md:mb-10 lg:mb-14 max-w-xs sm:max-w-lg md:max-w-2xl lg:max-w-4xl xl:max-w-4xl mx-auto leading-tight">
