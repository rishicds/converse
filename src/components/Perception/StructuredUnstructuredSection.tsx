      ...
      <div className="grid lg:grid-cols-2 gap-16 lg:items-stretch">
        ...
        <div className="flex flex-col">
          ...
          <div className="flex-1 flex flex-col">
            ...
            <ol className="mt-12 grid sm:grid-cols-2 gap-4 bg-[#6bb7d4] text-white p-6 rounded shadow-inner text-sm md:text-base font-medium">
              {issues.map((issue, i) => (
            ...
            <p className="mt-12 font-semibold text-[#1d2d3a] font-raleway">
